...
public class ReseauIP {     private String adresseReseau;     private int masqueCidr;     private String description; 
...
description) { 
    ...
    public void setAdresseReseau(String adresseReseau) { 
        ...
        if (adresseReseau == null || adresseReseau.isEmpty()) { 
            System.out.println("Adresse réseau invalide.");             this.adresseReseau = "0.0.0.0"; 
        } else { 
    ...
    public void setMasqueCidr(int masqueCidr) { 
        ...
        if (masqueCidr < 0 || masqueCidr > 32) {             System.out.println("Masque CIDR invalide.");             this.masqueCidr = 24; 
